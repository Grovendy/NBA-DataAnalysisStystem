...
public class PlayerStat extends JPanel{
	...
	private void initTable(){
		try {
			volist=ServiceFactoryImpl.getInstance().getPlayerService().getPlayerTotalBySeason("21-22",1);
			volistavg=ServiceFactoryImpl.getInstance().getPlayerService().getPlayerPerGameBySeason("21-22",1);
			volistadv = ServiceFactoryImpl.getInstance().getPlayerService().getPlayerAdvancedBySeason("21-22", 1);

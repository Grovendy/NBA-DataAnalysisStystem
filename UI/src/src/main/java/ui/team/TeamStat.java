...
public class TeamStat extends JPanel{
	...
	private void initData(){
		try {
			list1 = ServiceFactoryImpl.getInstance().getTeamService().getTeamPerGameBySeason("21-22");
			list2 = ServiceFactoryImpl.getInstance().getTeamService().getTeamTotalBySeason("21-22");

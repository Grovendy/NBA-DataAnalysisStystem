...
public class TeamServiceImpl extends UnicastRemoteObject implements TeamService {
	...
	private TeamTotalVO getTeamTotalToVO(TeamStatsTotal tst) {
		...
		vo.num_of_game = tst.getNumOfGame();
		vo.minute = tst.getMinute();
		vo.fg = tst.getFg();
		vo.fga = tst.getFga();
		vo.fga_pct = tst.getFgaPct();
		vo.fg3 = tst.getFg3();
		vo.fg3a = tst.getFg3a();
		vo.fg3_pct = tst.getFg3Pct();
		vo.fg2 = tst.getFg2();
		vo.fg2a = tst.getFg2a();
		vo.fg2_pct = tst.getFg2Pct();
		vo.ft = tst.getFt();
		vo.fta = tst.getFta();
		vo.ft_pct = tst.getFtPct();
		vo.orb = tst.getOrb();
		vo.drb = tst.getDrb();
		vo.trb = tst.getTrb();
		vo.ast = tst.getAst();
	...
	private TeamOppTotalVO getOppTotalVO(OpponentStatsTotal ost) {
		...
		vo.num_of_game = ost.getNumOfGame();
		vo.minute = ost.getMinute();
		vo.fg = ost.getFg();
		vo.fga = ost.getFga();
		vo.fga_pct = ost.getFgaPct();
		vo.fg3 = ost.getFg3();
		vo.fg3a = ost.getFg3a();
		vo.fg3_pct = ost.getFg3Pct();
		vo.fg2 = ost.getFg2();
		vo.fg2a = ost.getFg2a();
		vo.fg2_pct = ost.getFg2Pct();
		vo.ft = ost.getFt();
		vo.fta = ost.getFta();
		vo.ft_pct = ost.getFtPct();
		vo.orb = ost.getOrb();
		vo.drb = ost.getDrb();
		vo.trb = ost.getTrb();
		vo.ast = ost.getAst();
